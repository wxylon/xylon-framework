package com.xylon.utils.trietree;

/**
 * 如果我是生在太平时代，只不过是个初出茅庐的历史学者罢了，搞不好还是个默默无名的小人物呢。
 * http://www.iteye.com/topic/396961                                                                  ------杨威利
...
public class TrieTree {
	...
	public static void main(String[] args) {
		...
		tt.insertTrieTree("欢迎");
		tt.insertTrieTree("欢迎光临");
		tt.insertTrieTree("上海");
		tt.insertTrieTree("上海浦东");
		tt.insertTrieTree("上海浦东发展银行");
		tt.insertTrieTree("主页");
		tt.searchTrieTree("欢迎光临上海浦东发展银行的主页");
