 ...
 *         ***************************************************
 */
public class WsServiceSOAPHeaderIntercepter extends AbstractPhaseInterceptor<SoapMessage> {

    Log logger = LogFactory.getLog(WsServiceSOAPHeaderIntercepter.class);
    private WsServiceAuthHeader authHeader;

    public WsServiceSOAPHeaderIntercepter() {
    ...
    public void setAuthHeader(WsServiceAuthHeader authHeader) {
